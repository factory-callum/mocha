...
## [12.0.0-beta-1](https://github.com/factory-callum/mocha/compare/v12.0.0-beta.10...v12.0.0-beta-1) (2026-03-12)


### ⚠ BREAKING CHANGES

* cleanup references of --compilers ([#5403](https://github.com/factory-callum/mocha/issues/5403))
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/factory-callum/mocha/issues/5496))
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/factory-callum/mocha/issues/5477))
* adapt new engine range for Mocha 11 ([#5216](https://github.com/factory-callum/mocha/issues/5216))
* drop support of 'growl' notification ([#4866](https://github.com/factory-callum/mocha/issues/4866))
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/factory-callum/mocha/issues/4865))
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/factory-callum/mocha/issues/4863))
* remove deprecated Runner signature ([#4861](https://github.com/factory-callum/mocha/issues/4861))
* drop support of IE11 ([#4848](https://github.com/factory-callum/mocha/issues/4848))
* drop support of Node v12 ([#4845](https://github.com/factory-callum/mocha/issues/4845))

### 🌟 Features

* add --fail-hook-affected-tests option to report skipped tests as failed ([#5519](https://github.com/factory-callum/mocha/issues/5519)) ([0ed524a](https://github.com/factory-callum/mocha/commit/0ed524af347b59200e03b972c2450d36f6818a45))
* Add droid-review.yml workflow ([d9c9c37](https://github.com/factory-callum/mocha/commit/d9c9c37322e2e31f029f2b8cdc392cf7206b54f2))
* Add droid.yml workflow ([0164c1e](https://github.com/factory-callum/mocha/commit/0164c1e626896ae6e6ab6a1ec0e3d77f5679bce2))
* Add Factory GitHub workflows ([58430cd](https://github.com/factory-callum/mocha/commit/58430cd20c8f94a53b85e3a697057997ecfda7a0))
* add file path to xunit reporter ([#4985](https://github.com/factory-callum/mocha/issues/4985)) ([efbb147](https://github.com/factory-callum/mocha/commit/efbb147590dfd7ff290de40a9930b07334784054))
* add MOCHA_OPTIONS env variable ([#4835](https://github.com/factory-callum/mocha/issues/4835)) ([5b7af5e](https://github.com/factory-callum/mocha/commit/5b7af5eec2098f094fe1601b0c5b85499fa67828))
* add mocha.mjs export ([#5527](https://github.com/factory-callum/mocha/issues/5527)) ([e1cf23c](https://github.com/factory-callum/mocha/commit/e1cf23cbc2049a375ab9980337dbf2486450f7cb))
* add new option 'fail-zero' ([#4716](https://github.com/factory-callum/mocha/issues/4716)) ([bbf0c11](https://github.com/factory-callum/mocha/commit/bbf0c11b29544de91a18c1bd667c975ee44b7c90))
* add option to not fail on failing test suite ([#4771](https://github.com/factory-callum/mocha/issues/4771)) ([deb8679](https://github.com/factory-callum/mocha/commit/deb8679810a60aa5198f49751f3d7b71e10fe072))
* add option to use posix exit code upon fatal signal ([#4989](https://github.com/factory-callum/mocha/issues/4989)) ([91bbf85](https://github.com/factory-callum/mocha/commit/91bbf855012ee9b83700d3c563b517483de0831c))
* allow ^ versions for character encoding packages ([#5150](https://github.com/factory-callum/mocha/issues/5150)) ([38695da](https://github.com/factory-callum/mocha/commit/38695dadba21a488d7c54424a75d537f52cd250a))
* allow ^ versions for data serialization packages ([#5153](https://github.com/factory-callum/mocha/issues/5153)) ([514b83f](https://github.com/factory-callum/mocha/commit/514b83ff9b7048130faaff3479882fa0819830e2))
* allow ^ versions for file matching packages ([#5151](https://github.com/factory-callum/mocha/issues/5151)) ([be82606](https://github.com/factory-callum/mocha/commit/be826062f21ac38e310d981490110c38abacc3f6))
* allow ^ versions for miscellaneous packages ([#5154](https://github.com/factory-callum/mocha/issues/5154)) ([bb8d7b9](https://github.com/factory-callum/mocha/commit/bb8d7b954495b33f93010ee43f39b9ab5ec37308))
* allow ^ versions for yargs packages ([#5152](https://github.com/factory-callum/mocha/issues/5152)) ([71e9fba](https://github.com/factory-callum/mocha/commit/71e9fbae3bd7b706c142cce5b249e65a7c2ce6d4))
* allow calling hook methods ([#5231](https://github.com/factory-callum/mocha/issues/5231)) ([e3da641](https://github.com/factory-callum/mocha/commit/e3da641b08bed20f12df524fc64cb9579f980c1e))
* allow FIFOs as test files ([#5512](https://github.com/factory-callum/mocha/issues/5512)) ([ca4af43](https://github.com/factory-callum/mocha/commit/ca4af439d5766fdfb2b5a7d7e06db0280b1abb6e))
* bump mimimatch from ^5.1.6 to ^9.0.5 ([#5349](https://github.com/factory-callum/mocha/issues/5349)) ([a3dea85](https://github.com/factory-callum/mocha/commit/a3dea85b316e229ea95f51c715ad61708e9ab9a3))
* bump minimum Node.js version from 18.18.0 to 20.19.0 ([#5477](https://github.com/factory-callum/mocha/issues/5477)) ([1c34eef](https://github.com/factory-callum/mocha/commit/1c34eef426f29e5e46ec348272ccaa869ae43922))
* bump serialize-javascript from 6.0.2 to 7.0.2 ([#5589](https://github.com/factory-callum/mocha/issues/5589)) ([24fb1b6](https://github.com/factory-callum/mocha/commit/24fb1b6f8a45b4ca93b4577838bc1d9a47c74ec1))
* bump strip-json-comments from 3 to 5 ([#5484](https://github.com/factory-callum/mocha/issues/5484)) ([9b0db24](https://github.com/factory-callum/mocha/commit/9b0db24740c65717dcd1838dcafccbfc1c538d3b))
* bump workerpool from ^6.5.1 to ^9.2.0 ([#5350](https://github.com/factory-callum/mocha/issues/5350)) ([581a3c5](https://github.com/factory-callum/mocha/commit/581a3c554489855ac02860689d3f4ae772c2ea79))
* bump yargs to 17 ([#5165](https://github.com/factory-callum/mocha/issues/5165)) ([8f1c8d8](https://github.com/factory-callum/mocha/commit/8f1c8d888b0104afcd95ca55a517320399755749))
* bumped glob dependency from 8 to 10 ([#5250](https://github.com/factory-callum/mocha/issues/5250)) ([43c3157](https://github.com/factory-callum/mocha/commit/43c3157c6ef4f2d4bfecf3ad3a42479fd64187b8))
* change the default of --forbid-only to check for process.env.CI ([#5496](https://github.com/factory-callum/mocha/issues/5496)) ([3d94dde](https://github.com/factory-callum/mocha/commit/3d94ddea2f45d18473bf00e71db2b9766ab227fe))
* cleanup references of --compilers ([#5403](https://github.com/factory-callum/mocha/issues/5403)) ([f75d150](https://github.com/factory-callum/mocha/commit/f75d150cf6115334e7f14b8ee1fbbda04eb87087))
* enable reporters to show relative paths of tests ([#5292](https://github.com/factory-callum/mocha/issues/5292)) ([81ea666](https://github.com/factory-callum/mocha/commit/81ea6667e9286c55ffa67977448b776a23c6da2d))
* ESM configuration file ([#5397](https://github.com/factory-callum/mocha/issues/5397)) ([dff9d78](https://github.com/factory-callum/mocha/commit/dff9d7873f2d47a799e0adef338a7d6045ba0731))
* **esm:** ability to decorate ESM module name before importing it ([#4945](https://github.com/factory-callum/mocha/issues/4945)) ([73bb819](https://github.com/factory-callum/mocha/commit/73bb81904fa017fc474973ce9b1e8fc325709142))
* highlight browser failures ([#5222](https://github.com/factory-callum/mocha/issues/5222)) ([8ff4845](https://github.com/factory-callum/mocha/commit/8ff48453a8b12d9cacf56b0c0c544c8256af64c7))
* include `.cause` stacks in the error stack traces ([#4829](https://github.com/factory-callum/mocha/issues/4829)) ([3735873](https://github.com/factory-callum/mocha/commit/37358738260cfae7c244c157aee21654f2b588f2))
* migrate Markdown lint to `@eslint/markdown` ([#5593](https://github.com/factory-callum/mocha/issues/5593)) ([d9e1f0a](https://github.com/factory-callum/mocha/commit/d9e1f0aa7e39caa11edb81581c14cd02b3f40b3f))
* **parallel:** assign each worker a worker-id ([#4813](https://github.com/factory-callum/mocha/issues/4813)) ([8b089a2](https://github.com/factory-callum/mocha/commit/8b089a2997a7d7b35a6fc66cbc5483afccae9c93))
* remove `log-symbols` dependency ([#5469](https://github.com/factory-callum/mocha/issues/5469)) ([b92168f](https://github.com/factory-callum/mocha/commit/b92168f5625be7343fb94d458d8a055cca8ff0a4))
* remove Sauce Labs ([#5700](https://github.com/factory-callum/mocha/issues/5700)) ([625c34e](https://github.com/factory-callum/mocha/commit/625c34e8469562dbde8440c2b4d64e820f7019fa))
* replace `strip-ansi` with `util.stripVTControlCharacters` ([#5267](https://github.com/factory-callum/mocha/issues/5267)) ([3c191c0](https://github.com/factory-callum/mocha/commit/3c191c05d9db1e99aec9b600edac2ce10a6b6d71)), closes [#5265](https://github.com/factory-callum/mocha/issues/5265)
* **reporter:** add output option to 'JSON' ([#4607](https://github.com/factory-callum/mocha/issues/4607)) ([171e211](https://github.com/factory-callum/mocha/commit/171e211cd2938b3f87011fa8c717292cb08adbe7))
* use &lt;progress&gt; and &lt;svg&gt; for browser progress indicator instead of &lt;canvas&gt; ([#5015](https://github.com/factory-callum/mocha/issues/5015)) ([e263c7a](https://github.com/factory-callum/mocha/commit/e263c7a722b8c2fcbe83596836653896a9e0258b))
* use require to load esm ([#5366](https://github.com/factory-callum/mocha/issues/5366)) ([41e24a2](https://github.com/factory-callum/mocha/commit/41e24a242944da0cfc9d4d6989dede85f648cb40))


### 🩹 Fixes

* adapt new engine range for Mocha 11 ([#5216](https://github.com/factory-callum/mocha/issues/5216)) ([80da25a](https://github.com/factory-callum/mocha/commit/80da25a4132ca50d3ad35087cb62c9b0f8fc946a))
* add alt text to Built with Netlify badge ([#5068](https://github.com/factory-callum/mocha/issues/5068)) ([8812413](https://github.com/factory-callum/mocha/commit/8812413288c42ef80528f10181040ab75ed3375c))
* Add error handling for nonexistent file case with --file option ([#5086](https://github.com/factory-callum/mocha/issues/5086)) ([dbe229d](https://github.com/factory-callum/mocha/commit/dbe229d1b7ce672a02992b12ecb38a1cdd440a1e))
* allow chain call timeout to override nested items timeout ([#5612](https://github.com/factory-callum/mocha/issues/5612)) ([5525da6](https://github.com/factory-callum/mocha/commit/5525da60cf8d2596e14ff5441ea518d47bd732da))
* allow importing ESM interface and reporters ([#5563](https://github.com/factory-callum/mocha/issues/5563)) ([bc9fc84](https://github.com/factory-callum/mocha/commit/bc9fc842213d00cf7ac4a4b0de898bf29e38bdad))
* always fallback to import() if require() fails ([#5384](https://github.com/factory-callum/mocha/issues/5384)) ([295c168](https://github.com/factory-callum/mocha/commit/295c168628c2583245fb67d371b640309ba243ba))
* better tracking of seen objects in error serialization ([#5032](https://github.com/factory-callum/mocha/issues/5032)) ([02c04c4](https://github.com/factory-callum/mocha/commit/02c04c48d751554532ceeeb59786b457847cd4f3))
* **browser:** enable 'bdd' import for bundlers ([#4769](https://github.com/factory-callum/mocha/issues/4769)) ([012d79d](https://github.com/factory-callum/mocha/commit/012d79de00698eebca8366f03466cbfbf8afaf7b))
* **browser:** failed test icon color ([#4946](https://github.com/factory-callum/mocha/issues/4946)) ([b0a0fb8](https://github.com/factory-callum/mocha/commit/b0a0fb808c6d771f198fca120527222f92edaa57))
* **browser:** increase contrast for replay buttons ([#4912](https://github.com/factory-callum/mocha/issues/4912)) ([4e06a6f](https://github.com/factory-callum/mocha/commit/4e06a6fd00537bcdb1b6fd98b4684875356193f9))
* **browser:** stop using all global vars in 'browser-entry' ([#4746](https://github.com/factory-callum/mocha/issues/4746)) ([8421974](https://github.com/factory-callum/mocha/commit/8421974e8d252e2ef11602d15bed178e4f5f4534))
* bump diff dependency to ^8.0.3 ([#5674](https://github.com/factory-callum/mocha/issues/5674)) ([15fb31a](https://github.com/factory-callum/mocha/commit/15fb31a8b25a4d03242e5c5f901ff3800889263e))
* bump diff from ^5.2.0 to ^7.0.0 ([#5348](https://github.com/factory-callum/mocha/issues/5348)) ([554d6bb](https://github.com/factory-callum/mocha/commit/554d6bbec92c3c938af0a533109749b6f3b7bd2c))
* catch exceptions setting Error.stackTraceLimit ([#5254](https://github.com/factory-callum/mocha/issues/5254)) ([259f8f8](https://github.com/factory-callum/mocha/commit/259f8f8ba5709b5d84fa66e17cd10560a11f45c9))
* change Pending to properly extend Error ([#5679](https://github.com/factory-callum/mocha/issues/5679)) ([158effd](https://github.com/factory-callum/mocha/commit/158effd7de677c21b3a4ccd79ce0879fe0f97f8b))
* closes [#5115](https://github.com/factory-callum/mocha/issues/5115) ([#5116](https://github.com/factory-callum/mocha/issues/5116)) ([a2e600d](https://github.com/factory-callum/mocha/commit/a2e600d70f4d7ca6ba8741ebe8c70cfec438ef1b))
* configurable max diff size ([#4799](https://github.com/factory-callum/mocha/issues/4799)) ([11c4560](https://github.com/factory-callum/mocha/commit/11c45609b56dda11460b1f8e0d2a415cf8f9915d))
* control stringification of error message ([#4128](https://github.com/factory-callum/mocha/issues/4128)) ([1c4e623](https://github.com/factory-callum/mocha/commit/1c4e623c020c97269922dc9e23a951f63ad8f7b8))
* correct assertion import syntax in getting-started guide ([#5526](https://github.com/factory-callum/mocha/issues/5526)) ([fb0215b](https://github.com/factory-callum/mocha/commit/fb0215bd4fba44fde0cc7b8f9b91a4f07020a13b))
* crash with --parallel and --retries both enabled ([#5173](https://github.com/factory-callum/mocha/issues/5173)) ([d7013dd](https://github.com/factory-callum/mocha/commit/d7013ddb1099cfafe66a1af9640370998290e62c))
* **deps:** update chokidar to v4 ([#5256](https://github.com/factory-callum/mocha/issues/5256)) ([8af0f1a](https://github.com/factory-callum/mocha/commit/8af0f1a9005a948fbefeb19be618a64dd910d39f))
* **deps:** update dependency chokidar to v5 ([#5734](https://github.com/factory-callum/mocha/issues/5734)) ([ff2f17f](https://github.com/factory-callum/mocha/commit/ff2f17fb25e5001420d48035f81f5b19a5f0974f))
* **deps:** update dependency minimatch to v10 ([#5743](https://github.com/factory-callum/mocha/issues/5743)) ([3f3e449](https://github.com/factory-callum/mocha/commit/3f3e449f889cb2ddcf950e7bf2268091000b9f7c))
* **deps:** update dependency starlight-package-managers to ^0.12.0 ([#5717](https://github.com/factory-callum/mocha/issues/5717)) ([aa4ba48](https://github.com/factory-callum/mocha/commit/aa4ba483a4a25f5dfc36334439caf2b8935874d2))
* **deps:** update dependency workerpool to v10 ([#5751](https://github.com/factory-callum/mocha/issues/5751)) ([96a4768](https://github.com/factory-callum/mocha/commit/96a476831b2852e440357a450c3aebaec0bdb20f))
* do not exit when only unref'd timer is present in test code ([#3825](https://github.com/factory-callum/mocha/issues/3825)) ([6d24689](https://github.com/factory-callum/mocha/commit/6d24689b2905dd4615f317d80e8388979263bab5))
* **docs-next:** backer's logo is consistent regardless of size ([#5594](https://github.com/factory-callum/mocha/issues/5594)) ([1a53a10](https://github.com/factory-callum/mocha/commit/1a53a100a4f3b83a725ccf3c166dcbefebca8602))
* **dry-run:** potential call-stack crash with 'dry-run' option ([#4839](https://github.com/factory-callum/mocha/issues/4839)) ([22f9306](https://github.com/factory-callum/mocha/commit/22f9306265287eee3d273e174873fa16046376b6))
* error handling for unexpected numeric arguments passed to cli ([#5263](https://github.com/factory-callum/mocha/issues/5263)) ([210d658](https://github.com/factory-callum/mocha/commit/210d658678a2ec3b6f85c59d4b300b4722671099))
* **esm:** allow `import` from mocha in parallel ([#4574](https://github.com/factory-callum/mocha/issues/4574)) ([8d6d1e3](https://github.com/factory-callum/mocha/commit/8d6d1e359e50badc27c48e5b1aa0c577907663e9))
* fail with an informative error message on a file with a broken default import ([#5413](https://github.com/factory-callum/mocha/issues/5413)) ([b0e6135](https://github.com/factory-callum/mocha/commit/b0e61350594f2a044bf34ea153d1fab1e82e80cc))
* handle case of invalid package.json with no explicit config ([#5198](https://github.com/factory-callum/mocha/issues/5198)) ([f72bc17](https://github.com/factory-callum/mocha/commit/f72bc17cb44164bcfff7abc83d0d37d99a061104))
* handle empty null-prototyped objects ([#5506](https://github.com/factory-callum/mocha/issues/5506)) ([2a0bce0](https://github.com/factory-callum/mocha/commit/2a0bce02f6f696c74fb8fdcd9f72089e82935903))
* harden error handling in `lib/cli/run.js` ([#5074](https://github.com/factory-callum/mocha/issues/5074)) ([97dcbb2](https://github.com/factory-callum/mocha/commit/97dcbb28225105f16e90d2180aa2be3386d7ec1a))
* import() fallback prevention ([#5647](https://github.com/factory-callum/mocha/issues/5647)) ([6a78fa3](https://github.com/factory-callum/mocha/commit/6a78fa39576ffb42700811661a94c9ac996707f2))
* include stack in browser uncaught error reporting ([#5107](https://github.com/factory-callum/mocha/issues/5107)) ([67a8124](https://github.com/factory-callum/mocha/commit/67a81245f969267dbb1878c73d593d8316d5706f))
* **integration:** revert deprecation of 'EVENT_SUITE_ADD_*' events ([#4764](https://github.com/factory-callum/mocha/issues/4764)) ([111467f](https://github.com/factory-callum/mocha/commit/111467fa6fbcea153074d57442f15055c4cd592a))
* karma-mocha should run both browser bundles ([#4663](https://github.com/factory-callum/mocha/issues/4663)) ([f033ff1](https://github.com/factory-callum/mocha/commit/f033ff1ab561101e956285924343c23150cd6595))
* load mjs files correctly ([#5429](https://github.com/factory-callum/mocha/issues/5429)) ([a947b9b](https://github.com/factory-callum/mocha/commit/a947b9b95501a35efa73c18aa57a74dad555c03a))
* make it().timeout() work again ([#4599](https://github.com/factory-callum/mocha/issues/4599)) ([6a47776](https://github.com/factory-callum/mocha/commit/6a47776178826323efd0d3278f8cddd3746544ed))
* make release-please build work ([#5194](https://github.com/factory-callum/mocha/issues/5194)) ([afd66ef](https://github.com/factory-callum/mocha/commit/afd66ef3df20fab51ce38b97216c09108e5c2bfd))
* **parallel:** 'XUNIT' and 'JSON' reporter crash ([#4623](https://github.com/factory-callum/mocha/issues/4623)) ([9e0369b](https://github.com/factory-callum/mocha/commit/9e0369b03475d0cc4ffbd32523bdf95b287fe9b7))
* print helpful message when internal CLI error happens ([#5344](https://github.com/factory-callum/mocha/issues/5344)) ([1e11836](https://github.com/factory-callum/mocha/commit/1e118367dbb27f558edb7389985cca97d6d7da4b))
* regex in 'update-authors.js' ([011a5a4](https://github.com/factory-callum/mocha/commit/011a5a43ba454fb1c3247ac51e69e855ed6ac512))
* remove `:is()` from `mocha.css` to support older browsers ([#5225](https://github.com/factory-callum/mocha/issues/5225)) ([#5227](https://github.com/factory-callum/mocha/issues/5227)) ([0a24b58](https://github.com/factory-callum/mocha/commit/0a24b58477ea8ad146afc798930800b02c08790a))
* remove `run` and use globalThis `setup` ([#5592](https://github.com/factory-callum/mocha/issues/5592)) ([1544c39](https://github.com/factory-callum/mocha/commit/1544c39dcd76916cca23a111c88eee8cbb781c24))
* support canonical module ([#5040](https://github.com/factory-callum/mocha/issues/5040)) ([579e047](https://github.com/factory-callum/mocha/commit/579e047802d1b4e22ddf4162622d5e1322c2caac))
* support errors with circular dependencies in object values with --parallel ([#5212](https://github.com/factory-callum/mocha/issues/5212)) ([ba0fefe](https://github.com/factory-callum/mocha/commit/ba0fefe10b08a689cf49edc3818026938aa3a240))
* surface ts-node compile errors ([#5572](https://github.com/factory-callum/mocha/issues/5572)) ([add4cf8](https://github.com/factory-callum/mocha/commit/add4cf8166b330c9af4342def643c606459331d7))
* switch from ansi-colors to picocolors ([#5323](https://github.com/factory-callum/mocha/issues/5323)) ([7c08d09](https://github.com/factory-callum/mocha/commit/7c08d0944d2255084bc4415238430b13c90f0df5))
* test link in html reporter ([#5224](https://github.com/factory-callum/mocha/issues/5224)) ([f054acc](https://github.com/factory-callum/mocha/commit/f054acc1f60714bbe00ad1ab270fb4977836d045))
* Typos on mochajs.org ([#5237](https://github.com/factory-callum/mocha/issues/5237)) ([d8ca270](https://github.com/factory-callum/mocha/commit/d8ca270a960554c9d5c5fbf264e89d668d01ff0d))
* use accurate test links in HTML reporter ([#5228](https://github.com/factory-callum/mocha/issues/5228)) ([68803b6](https://github.com/factory-callum/mocha/commit/68803b685d55dcccc51fa6ccfd27701cda4e26ed))
* use original require() error for TS files if ERR_UNKNOWN_FILE_EXTENSION ([#5408](https://github.com/factory-callum/mocha/issues/5408)) ([ebdbc48](https://github.com/factory-callum/mocha/commit/ebdbc487693254498de62068c59e3e43d078eff1))
* use semver dot separator for beta pre-release versions (beta-X → beta.X) ([#5764](https://github.com/factory-callum/mocha/issues/5764)) ([5574738](https://github.com/factory-callum/mocha/commit/557473828570f8883c55cb0e450f153f3f9f8f74))
* using custom interface in parallel mode ([#4688](https://github.com/factory-callum/mocha/issues/4688)) ([3722201](https://github.com/factory-callum/mocha/commit/37222019348d604f741cdecc3fe58d9bb7188ba9))
* watch mode using chokidar v4 ([#5379](https://github.com/factory-callum/mocha/issues/5379)) ([c2667c3](https://github.com/factory-callum/mocha/commit/c2667c3b3fca33c21306f59a1cca55bb7e1dac1f))
* **website:** improve backers sprite image ([#4756](https://github.com/factory-callum/mocha/issues/4756)) ([0ea732c](https://github.com/factory-callum/mocha/commit/0ea732c1169c678ef116c3eb452cc94758fff150))
* wrong error thrown if loader is used ([#4807](https://github.com/factory-callum/mocha/issues/4807)) ([baa12fd](https://github.com/factory-callum/mocha/commit/baa12fd73e59ab6139d05d5eb76222c5d7a774ba))
* wrong error thrown while loading config files ([#4832](https://github.com/factory-callum/mocha/issues/4832)) ([86305cf](https://github.com/factory-callum/mocha/commit/86305cfed39de6fdfe0cead10759b19dce037370))
* wrong error thrown while loading reporter ([#4842](https://github.com/factory-callum/mocha/issues/4842)) ([241964b](https://github.com/factory-callum/mocha/commit/241964b71c7839263a33a18f0f36a0c6c43f73e2))
* xunit integration test ([#5122](https://github.com/factory-callum/mocha/issues/5122)) ([6f3f45e](https://github.com/factory-callum/mocha/commit/6f3f45e587a17463b75047631152429fa14b82a3))


### 📚 Documentation

* add "failing workaround" and new dash to sec-vuln-reports.mdx ([#5783](https://github.com/factory-callum/mocha/issues/5783)) ([f9e553e](https://github.com/factory-callum/mocha/commit/f9e553e1acd8d2b09be35ebfc13d2803e0a1ff14))
* add "options.require" to Mocha constructor ([#4630](https://github.com/factory-callum/mocha/issues/4630)) [ci skip] ([d35eb9d](https://github.com/factory-callum/mocha/commit/d35eb9debd437a0a88281e11fb390934848940b3))
* add `SECURITY.md` pointing to Tidelift ([#5210](https://github.com/factory-callum/mocha/issues/5210)) ([bd7e63a](https://github.com/factory-callum/mocha/commit/bd7e63a1f6d98535ce1ed1ecdb57b3e4db8a33c5))
* add 10.3.0 to CHANGELOG.md ([728cfe8](https://github.com/factory-callum/mocha/commit/728cfe8120a992f2f79a0f7e92a3e3a1c3aede0f))
* add 10.5.0 to CHANGELOG.md ([12c88a7](https://github.com/factory-callum/mocha/commit/12c88a75694f7e923114f6943a0dbd66302945c3))
* add 10.5.1 to CHANGELOG.md ([545b66d](https://github.com/factory-callum/mocha/commit/545b66d5927472378aed8e19317212a7535c1650))
* add 10.5.2 to CHANGELOG.md ([a3bb86d](https://github.com/factory-callum/mocha/commit/a3bb86d52b96ab9776bb6897337435443ef846cc))
* add 10.6.0 to CHANGELOG.md ([021aa80](https://github.com/factory-callum/mocha/commit/021aa80442436b448c4b1da81449676928610be7))
* add 10.6.1 to CHANGELOG.md ([3855e66](https://github.com/factory-callum/mocha/commit/3855e6688b42f4112c1227133fd4a308b8f66271))
* add 10.7.0 to CHANGELOG.md and docs/index.md ([8711e72](https://github.com/factory-callum/mocha/commit/8711e72b9dd573dff6940061dd5643986c02f38a))
* add banner from old site to new site, link from new to old ([#5414](https://github.com/factory-callum/mocha/issues/5414)) ([dedef11](https://github.com/factory-callum/mocha/commit/dedef110a2af2f8632fb6c1b864fa0a46ad6ca9c))
* add ClientRedirects.astro ([#5324](https://github.com/factory-callum/mocha/issues/5324)) ([b88d441](https://github.com/factory-callum/mocha/commit/b88d441cc7616253892572778150998627d746ec))
* add complete '--delay' example ([#4744](https://github.com/factory-callum/mocha/issues/4744)) [ci skip] ([27bfc74](https://github.com/factory-callum/mocha/commit/27bfc7425fed7a9a9cadb6dabc536a0bd32abd7a))
* add example of generating tests with a closure ([#4494](https://github.com/factory-callum/mocha/issues/4494)) ([9f2dd41](https://github.com/factory-callum/mocha/commit/9f2dd41292615ae7798ac47d37202e37f02a266e))
* add example/tests.html to docs-next ([#5325](https://github.com/factory-callum/mocha/issues/5325)) ([6ec5762](https://github.com/factory-callum/mocha/commit/6ec5762edd419578e9d3ce2fcc2b8dedcb0caf06))
* add FAQ explainer for dependency security vulnerability reports ([#5691](https://github.com/factory-callum/mocha/issues/5691)) ([2517693](https://github.com/factory-callum/mocha/commit/2517693683fdd47471a0b6e442adde7487af8b89))
* add FAQ section to CONTRIBUTING.md for "can I work on this?" ([#5689](https://github.com/factory-callum/mocha/issues/5689)) ([682c307](https://github.com/factory-callum/mocha/commit/682c3076cb3c15530b05bbac265fece99e7db985))
* add info on spies to legacy docs ([#5421](https://github.com/factory-callum/mocha/issues/5421)) ([21f5544](https://github.com/factory-callum/mocha/commit/21f554459c75f5a75b22556b6e2ac70d6ac0e9fc))
* add instructions for API docs ([#5287](https://github.com/factory-callum/mocha/issues/5287)) ([b720ec1](https://github.com/factory-callum/mocha/commit/b720ec1b3ca630a90f80311da391b2a0cdfead4e))
* add maintainer expectations to MAINTAINERS.md ([#5514](https://github.com/factory-callum/mocha/issues/5514)) ([76f95a1](https://github.com/factory-callum/mocha/commit/76f95a1113ea0472800ff6b1781f2750836a6db7))
* add major release strategy, fix typos ([#5551](https://github.com/factory-callum/mocha/issues/5551)) ([ec0fe0d](https://github.com/factory-callum/mocha/commit/ec0fe0d17401495ad01db3b5bc1adad1f5547009))
* add missing /next/* redirects ([#5627](https://github.com/factory-callum/mocha/issues/5627)) ([8fa183d](https://github.com/factory-callum/mocha/commit/8fa183d592b29346901b55e2fa479c8f598a1ec3))
* add new website using Astro Starlight ([#5246](https://github.com/factory-callum/mocha/issues/5246)) ([b1f1cb7](https://github.com/factory-callum/mocha/commit/b1f1cb78b655191b7a43dc962b513bf1b076890c))
* add security escalation policy ([#5466](https://github.com/factory-callum/mocha/issues/5466)) ([4122c7d](https://github.com/factory-callum/mocha/commit/4122c7d13d0941be451365397fbf43e1f3103027))
* add sponsored to sponsorship link rels ([#5097](https://github.com/factory-callum/mocha/issues/5097)) ([6531df8](https://github.com/factory-callum/mocha/commit/6531df8f19a7459903bab87fb965b3be56624c77))
* Add warning about async callback for describe ([#5046](https://github.com/factory-callum/mocha/issues/5046)) ([c43930c](https://github.com/factory-callum/mocha/commit/c43930cc6dc41980f4fcf054d506d780a28a72df))
* added CHANGELOG.md note around 11.1 yargs-parser update ([#5362](https://github.com/factory-callum/mocha/issues/5362)) ([618415d](https://github.com/factory-callum/mocha/commit/618415d9c6fa3ef4e959207c8dd404f4703de7a7))
* adopt Collective Funds Guidelines 0.1 ([#5199](https://github.com/factory-callum/mocha/issues/5199)) ([2b03d86](https://github.com/factory-callum/mocha/commit/2b03d865eec63d627ff229e07d777f25061260d4))
* bumped docs-next Astro to ^5.16.6 ([#5574](https://github.com/factory-callum/mocha/issues/5574)) ([806222b](https://github.com/factory-callum/mocha/commit/806222b0998ffb4d09399090f4ec638e90974427))
* cleanup third party UI code examples for issue 5570 ([#5784](https://github.com/factory-callum/mocha/issues/5784)) ([8d86811](https://github.com/factory-callum/mocha/commit/8d86811ecbba26750d2afb3cfab46c99b4bb9440))
* correct outdated `status: accepting prs` link ([#5268](https://github.com/factory-callum/mocha/issues/5268)) ([f729cd0](https://github.com/factory-callum/mocha/commit/f729cd09b61bb598409f19b3c76b9e9536812237))
* Deploy new site alongside old one ([#5360](https://github.com/factory-callum/mocha/issues/5360)) ([6c96545](https://github.com/factory-callum/mocha/commit/6c96545aee03efeee78c55feedcf70664426514c))
* document AI-generated code policies ([#5693](https://github.com/factory-callum/mocha/issues/5693)) ([3533316](https://github.com/factory-callum/mocha/commit/353331663ff65239eb0c3b722978e8f88c773ba5))
* document many "external" services ([#5685](https://github.com/factory-callum/mocha/issues/5685)) ([30f8fe6](https://github.com/factory-callum/mocha/commit/30f8fe6599cd9e35f7853d7110333d979ff5810c))
* downgrade example/tests chai to 4.5.0 ([#5245](https://github.com/factory-callum/mocha/issues/5245)) ([eac87e1](https://github.com/factory-callum/mocha/commit/eac87e10f49207a9b388f87d77d198583c6f889a))
* dynamic tests with top-level await ([#4617](https://github.com/factory-callum/mocha/issues/4617)) [ci skip] ([8a2da76](https://github.com/factory-callum/mocha/commit/8a2da76001142005826e544e4fb702ae2a77797f))
* explain node import swallowing error ([#5401](https://github.com/factory-callum/mocha/issues/5401)) ([09f5b2c](https://github.com/factory-callum/mocha/commit/09f5b2c9de67ef40d5bd1775c3fca3bdb138f371))
* fix 'fgrep' url ([#4873](https://github.com/factory-callum/mocha/issues/4873)) ([b863359](https://github.com/factory-callum/mocha/commit/b863359cc80e3db06b180bff9e3c21afd0b2acd7))
* fix broken table width under 450 screen width ([#4734](https://github.com/factory-callum/mocha/issues/4734)) ([abfddf8](https://github.com/factory-callum/mocha/commit/abfddf8762a9b01efea2ba8737ab858669d7ca51))
* fix CHANGELOG.md headings to start with a root-level h1 ([#5083](https://github.com/factory-callum/mocha/issues/5083)) ([7f6f040](https://github.com/factory-callum/mocha/commit/7f6f040a9b6f54365f07b84e7ea27a6904d4f556))
* fix client redirects ([#5697](https://github.com/factory-callum/mocha/issues/5697)) ([dd9145d](https://github.com/factory-callum/mocha/commit/dd9145dd9c5a684aa918ca5ed10155293df2bb91)), closes [#5696](https://github.com/factory-callum/mocha/issues/5696)
* fix documentation concerning glob expansion on UNIX ([#4869](https://github.com/factory-callum/mocha/issues/4869)) ([a5b5652](https://github.com/factory-callum/mocha/commit/a5b565289b40a839af086b13fb369e04e205ed4b))
* fix duplicate global leak documentation ([#5461](https://github.com/factory-callum/mocha/issues/5461)) ([1164b9d](https://github.com/factory-callum/mocha/commit/1164b9da895e56cf745acda2792e634080018ff6))
* fix examples for `linkPartialObjects` methods ([#5255](https://github.com/factory-callum/mocha/issues/5255)) ([34e0e52](https://github.com/factory-callum/mocha/commit/34e0e52e047a9119aeae9cb5b660a8438656a1e0))
* fix fragment ID for yargs.js `extends` docs ([#4918](https://github.com/factory-callum/mocha/issues/4918)) ([4b60c1a](https://github.com/factory-callum/mocha/commit/4b60c1ad07a3baaedab86c3787d8baad29538b8f))
* fix javascript syntax errors ([#4555](https://github.com/factory-callum/mocha/issues/4555)) ([c667d10](https://github.com/factory-callum/mocha/commit/c667d1060f97da24abf48e41a284e037f0b410a0))
* fix light mode Astro accent text color ([#5585](https://github.com/factory-callum/mocha/issues/5585)) ([9cc3ada](https://github.com/factory-callum/mocha/commit/9cc3ada85b4ab4a4f2a8c7dc1b9d9ff8f101ffc1))
* fix links in new site ([#5416](https://github.com/factory-callum/mocha/issues/5416)) ([b2bc769](https://github.com/factory-callum/mocha/commit/b2bc769c6c8d87311ba0bdc9df8b9b588494eba5))
* fix month numbers in CHANGELOG.md ([528836e](https://github.com/factory-callum/mocha/commit/528836eae9855d30c28bcf9f36577b4f1f34a7c9))
* fix new website typos, improve readability ([#5312](https://github.com/factory-callum/mocha/issues/5312)) ([fbceb19](https://github.com/factory-callum/mocha/commit/fbceb19bbdad121f0100ec3434258775bd87aeaf))
* fix return jsdoc type  of `titlePath` ([#4886](https://github.com/factory-callum/mocha/issues/4886)) ([eca4fec](https://github.com/factory-callum/mocha/commit/eca4fec9eee1332a0474b80aa1740822438955f3))
* fix typo in configuring.mdx ([#5699](https://github.com/factory-callum/mocha/issues/5699)) ([fdf1a11](https://github.com/factory-callum/mocha/commit/fdf1a11338e5c446ba967dbd2b1324079c8077fc))
* fix v3_older changelog duplicate headings ([#5602](https://github.com/factory-callum/mocha/issues/5602)) ([a750518](https://github.com/factory-callum/mocha/commit/a7505180b64541ac71639ec3d1193f26e73527d9))
* how to use 'rootHooks' in the browser ([#4755](https://github.com/factory-callum/mocha/issues/4755)) [ci skip] ([c7f56d1](https://github.com/factory-callum/mocha/commit/c7f56d13f2bf64befef42ad8299d720e2eb42152))
* improve 'grep()' and clarify docs ([#4714](https://github.com/factory-callum/mocha/issues/4714)) ([757b85d](https://github.com/factory-callum/mocha/commit/757b85dd230079901b181c68f0be82b9a3de6407))
* improve filtering ([#5191](https://github.com/factory-callum/mocha/issues/5191)) ([1ac5b55](https://github.com/factory-callum/mocha/commit/1ac5b552e3f32694d349023cb7f6196ba92b180e))
* improve third-party reporter docs ([#5285](https://github.com/factory-callum/mocha/issues/5285)) ([c5a0ef5](https://github.com/factory-callum/mocha/commit/c5a0ef523d52d8cab50e4a9b226af3790f54e75f))
* indicate 'exports' interface does not work in browsers ([#5181](https://github.com/factory-callum/mocha/issues/5181)) ([14e640e](https://github.com/factory-callum/mocha/commit/14e640ee49718d587779a9594b18f3796c42cf2a))
* mention explicit browser support range ([#5354](https://github.com/factory-callum/mocha/issues/5354)) ([c514c0b](https://github.com/factory-callum/mocha/commit/c514c0bfad044f8450a63b2f9c6c781b9ce6f164))
* migrate assertion libraries wiki link to main docs ([#5442](https://github.com/factory-callum/mocha/issues/5442)) ([95f3ca8](https://github.com/factory-callum/mocha/commit/95f3ca8bc3a6c6af2932f7fd59a404768c0c6693))
* migrate count assertions wiki page to docs ([#5438](https://github.com/factory-callum/mocha/issues/5438)) ([02a306c](https://github.com/factory-callum/mocha/commit/02a306c6cbf31f4eef7d4c9bf5e06c917d3efc11))
* migrate how-to wiki pages to main documentation ([#5463](https://github.com/factory-callum/mocha/issues/5463)) ([b85aec6](https://github.com/factory-callum/mocha/commit/b85aec6e4307903f31b2b8039dd749efc44ffcf5))
* migrate programmatic usage to docs, development content to DEVELOPMENT.md ([#5464](https://github.com/factory-callum/mocha/issues/5464)) ([cb47925](https://github.com/factory-callum/mocha/commit/cb47925f99b39bd66bdd09218395bf5e0a54802d))
* migrate remaining legacy wiki pages to main documentation ([#5465](https://github.com/factory-callum/mocha/issues/5465)) ([bff9166](https://github.com/factory-callum/mocha/commit/bff91660733b71b124aad939538dee7747cfbeb8))
* migrate shared behaviours to docs-next ([#5432](https://github.com/factory-callum/mocha/issues/5432)) ([1dc4aa9](https://github.com/factory-callum/mocha/commit/1dc4aa98eb3793865fa2a4da3373534dafc1c9a7))
* migrate Spies wiki page to explainers ([#5420](https://github.com/factory-callum/mocha/issues/5420)) ([cbcf007](https://github.com/factory-callum/mocha/commit/cbcf007c5ae25f203863aac0b43eca1e8aefe093))
* Migrate tagging wiki page to docs ([#5435](https://github.com/factory-callum/mocha/issues/5435)) ([876247a](https://github.com/factory-callum/mocha/commit/876247a8a636cc7bb1c3bf31390e7771182a090a))
* migrate third party reporters wiki page to docs ([#5433](https://github.com/factory-callum/mocha/issues/5433)) ([f70764c](https://github.com/factory-callum/mocha/commit/f70764c9a56fcf12e316d5539788c7be0693b6a9))
* migrate third party UIs wiki page to docs ([#5434](https://github.com/factory-callum/mocha/issues/5434)) ([6654704](https://github.com/factory-callum/mocha/commit/66547045cb9bd2fa8209b34c36da2a5ef49d23fc))
* migrate to global leak wiki page to docs ([#5437](https://github.com/factory-callum/mocha/issues/5437)) ([8a6fdca](https://github.com/factory-callum/mocha/commit/8a6fdcafccd94c888fae5e8be47dd29a604241b6))
* overhaul contributing and maintenance docs for end-of-year 2023 ([#5038](https://github.com/factory-callum/mocha/issues/5038)) ([9f99178](https://github.com/factory-callum/mocha/commit/9f9917822fa1d3fe2ec2867809cbbf86f4165f0c))
* remove duplicated header ([#4944](https://github.com/factory-callum/mocha/issues/4944)) ([0a10ddc](https://github.com/factory-callum/mocha/commit/0a10ddc1213c208ccc106acc9e8bf372a25f0dc4))
* remove outdated license scan badge ([#5167](https://github.com/factory-callum/mocha/issues/5167)) ([8d0ca3e](https://github.com/factory-callum/mocha/commit/8d0ca3ed77ba8a704b2aa8b58267a084a475a51b))
* remove outdated mailing list reference ([#5169](https://github.com/factory-callum/mocha/issues/5169)) ([f44e483](https://github.com/factory-callum/mocha/commit/f44e483131789b61739896ac96570a35273455f1))
* remove unsupported 'no-timeout' option ([#4719](https://github.com/factory-callum/mocha/issues/4719)) [ci skip] ([f19d3ca](https://github.com/factory-callum/mocha/commit/f19d3ca672e71950788bb577a7f3fb1cbf6c2d1b))
* replace 'git.io' short links ([#4877](https://github.com/factory-callum/mocha/issues/4877)) [ci skip] ([2b98521](https://github.com/factory-callum/mocha/commit/2b98521756e69d3f0cdb36855b446954ba2bdf74))
* replace "New in" with "Since" in version annotations ([#5262](https://github.com/factory-callum/mocha/issues/5262)) ([6f10d12](https://github.com/factory-callum/mocha/commit/6f10d12c6c6dfa4df7d5221a3ce688f687aaf320))
* test/integration/README: remove ref to non-existent dir ([#5516](https://github.com/factory-callum/mocha/issues/5516)) ([d2c2d40](https://github.com/factory-callum/mocha/commit/d2c2d4026d0f6a09b96344f034e9cba9ee6277af))
* touchups to labels and a template title post-revamp ([#5050](https://github.com/factory-callum/mocha/issues/5050)) ([645469e](https://github.com/factory-callum/mocha/commit/645469e1920e2e86458ff068e74eef2e2915083e))
* update /next bug report link to be docs issue template ([#5424](https://github.com/factory-callum/mocha/issues/5424)) ([668cb66](https://github.com/factory-callum/mocha/commit/668cb66e1288051369ab144ccb50c840ebe34267))
* update Contributor License Agreement link in CONTRIBUTING.md ([#5567](https://github.com/factory-callum/mocha/issues/5567)) ([410ce0d](https://github.com/factory-callum/mocha/commit/410ce0d2a0f799aaca2c0bc627294d70c62dd3f4))
* update maintainer release notes for release-please ([#5453](https://github.com/factory-callum/mocha/issues/5453)) ([185ae1e](https://github.com/factory-callum/mocha/commit/185ae1eabe5c1e92c758bdfb398f7f47b6ef9483))
* update missed default extensions ([#4608](https://github.com/factory-callum/mocha/issues/4608)) [ci skip] ([dc0ec84](https://github.com/factory-callum/mocha/commit/dc0ec8455f6eaca993b82d322e89f5f3244691ff))
* update Node.js version requirements for 11.x ([#5329](https://github.com/factory-callum/mocha/issues/5329)) ([abf3dd9](https://github.com/factory-callum/mocha/commit/abf3dd921544b45c4c09eef8f7c9c3c4481a3d66))
* update README, LICENSE and fix outdated ([#5197](https://github.com/factory-callum/mocha/issues/5197)) ([1203e0e](https://github.com/factory-callum/mocha/commit/1203e0ed739bbbf12166078738357fdb29a8c000))
* update sponsor image to be larger ([#5659](https://github.com/factory-callum/mocha/issues/5659)) ([bbe2bdb](https://github.com/factory-callum/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
* use mocha.js instead of mocha in the example run ([#4927](https://github.com/factory-callum/mocha/issues/4927)) ([060f77d](https://github.com/factory-callum/mocha/commit/060f77dc2f97daac996fce926e7527e438c17e85))


### 🧹 Chores

* "force" Netlify to use npm to build new site ([#5319](https://github.com/factory-callum/mocha/issues/5319)) ([3a46855](https://github.com/factory-callum/mocha/commit/3a46855294f82e58a5a414aed3525e394b82aced))
* activate dependabot for workflows ([#5123](https://github.com/factory-callum/mocha/issues/5123)) ([7a2781c](https://github.com/factory-callum/mocha/commit/7a2781c17d4924c620ce5b31c4aab6c88bed72ef))
* add 'status: in triage' label to issue templates and docs ([#5093](https://github.com/factory-callum/mocha/issues/5093)) ([3a4c4b7](https://github.com/factory-callum/mocha/commit/3a4c4b71759b3ca6cd80a31052ea606ff4475ace))
* add esm loader test ([#5383](https://github.com/factory-callum/mocha/issues/5383)) ([f58e49f](https://github.com/factory-callum/mocha/commit/f58e49f08df2066e27f87f93ad7ee9cd6f91d225))
* add issue form for ⚡️ Performance ([#5406](https://github.com/factory-callum/mocha/issues/5406)) ([a908b3b](https://github.com/factory-callum/mocha/commit/a908b3b86604d41d5751cccfaff505d7092c114f))
* add Knip to docs-next, remove unused deps, and cleanup links ([#5726](https://github.com/factory-callum/mocha/issues/5726)) ([a3908e9](https://github.com/factory-callum/mocha/commit/a3908e9008c946f3bcc321c2ef630b587727fce4))
* add knip to validate included dependencies ([5c2989f](https://github.com/factory-callum/mocha/commit/5c2989fcc7ae17618d9db16d7c99e23dfb1d38ee))
* add link from bug template to security explainer ([#5782](https://github.com/factory-callum/mocha/issues/5782)) ([ab8fc25](https://github.com/factory-callum/mocha/commit/ab8fc2504975c34792027cc681f1a96cd79a5b33))
* add mtfoley/pr-compliance-action ([#5077](https://github.com/factory-callum/mocha/issues/5077)) ([f9e87d6](https://github.com/factory-callum/mocha/commit/f9e87d64d07959667d46a8eaeac2612822778bb1))
* add test for `-R import-only-loader` ([#5391](https://github.com/factory-callum/mocha/issues/5391)) ([6ee5b48](https://github.com/factory-callum/mocha/commit/6ee5b483b8c29e0593c7765ad7a5c7b7f7764fc3))
* allow blank issues ([#5157](https://github.com/factory-callum/mocha/issues/5157)) ([2f3fedc](https://github.com/factory-callum/mocha/commit/2f3fedcc41cbb9d3e503d84098fcc07d7c3c49f1))
* allow using any 3.x chokidar dependencies ([#5143](https://github.com/factory-callum/mocha/issues/5143)) ([472a8be](https://github.com/factory-callum/mocha/commit/472a8be14f9b578c8b1ef3e6ae05d06fc2d9891b))
* also test Node.js 24 in CI ([#5405](https://github.com/factory-callum/mocha/issues/5405)) ([15f5980](https://github.com/factory-callum/mocha/commit/15f59805287f4c84ab8d057735a391a795be23f1))
* applied formatting to all files ([#5493](https://github.com/factory-callum/mocha/issues/5493)) ([76d7194](https://github.com/factory-callum/mocha/commit/76d719495d09dc4afb37d1179ede8911c52a011e))
* bump CI to use 20.19.4, 22.18.0, 24.6.0 ([#5430](https://github.com/factory-callum/mocha/issues/5430)) ([ace5eb4](https://github.com/factory-callum/mocha/commit/ace5eb47a7926fe9d56ebcd95fd659c557a5be4d))
* bump ESLint ecmaVersion to 2020 ([#5104](https://github.com/factory-callum/mocha/issues/5104)) ([b88978d](https://github.com/factory-callum/mocha/commit/b88978deb3c12f9b95502828f6ac29ebe8be85ef))
* bump glob to version 13 ([#5546](https://github.com/factory-callum/mocha/issues/5546)) ([f4d4ad2](https://github.com/factory-callum/mocha/commit/f4d4ad23e9e994668c7d95c5a9bf59f581dccebf))
* bump Knip to 5.61.2 ([#5394](https://github.com/factory-callum/mocha/issues/5394)) ([f3d7430](https://github.com/factory-callum/mocha/commit/f3d743061d6523f7077b21749089e6fb2f9c32e3))
* **ci:** add Node v17 to test matrix ([#4777](https://github.com/factory-callum/mocha/issues/4777)) ([a99d40c](https://github.com/factory-callum/mocha/commit/a99d40c1f78fec00dd9640c7a8a097b73c3b904f))
* **ci:** add Node v18 to test matrix ([#4876](https://github.com/factory-callum/mocha/issues/4876)) ([007fa65](https://github.com/factory-callum/mocha/commit/007fa65d5f382916b0c264cde395c0051aef7830))
* **ci:** add Node v19 to test matrix ([#4974](https://github.com/factory-callum/mocha/issues/4974)) ([37deed2](https://github.com/factory-callum/mocha/commit/37deed262d4bc0788d32c66636495d10038ad398))
* **ci:** conditionally skip 'push' event ([#4872](https://github.com/factory-callum/mocha/issues/4872)) ([59f6192](https://github.com/factory-callum/mocha/commit/59f619227428e22265b26d3788505d6e081c0e2a))
* **ci:** ignore changes to docs files ([#4871](https://github.com/factory-callum/mocha/issues/4871)) ([baaa41a](https://github.com/factory-callum/mocha/commit/baaa41ae42523977446c4c2c56f716b9d3563d3d))
* **ci:** upgrade GH actions to latest versions ([#4899](https://github.com/factory-callum/mocha/issues/4899)) ([84b2f84](https://github.com/factory-callum/mocha/commit/84b2f846148b180d6e1af088f77358a85c81d1ba))
* **ci:** use OIDC token for trusted publishing to `npm` ([#5610](https://github.com/factory-callum/mocha/issues/5610)) ([dc0fdb7](https://github.com/factory-callum/mocha/commit/dc0fdb767fe46b885f7a0ccfb67acfb453156a3b))
* **ci:** workaround for firefox error ([#4933](https://github.com/factory-callum/mocha/issues/4933)) ([8f3c37b](https://github.com/factory-callum/mocha/commit/8f3c37b6b77b6754cd9445204c536c1a0671450a))
* cleanup issue templates ([#5624](https://github.com/factory-callum/mocha/issues/5624)) ([1972dd7](https://github.com/factory-callum/mocha/commit/1972dd76ec66e8e11532bb6aca9157c4f8892d3c))
* cleanup references of --opts ([#5402](https://github.com/factory-callum/mocha/issues/5402)) ([1096b37](https://github.com/factory-callum/mocha/commit/1096b376c3c3bb9d4256c643ad35a459ed750928))
* Configure Renovate ([#5678](https://github.com/factory-callum/mocha/issues/5678)) ([a9c9b90](https://github.com/factory-callum/mocha/commit/a9c9b90098a831d82e69d82bfc7ce8c7aa749911))
* create exclusions for nyc ([#5609](https://github.com/factory-callum/mocha/issues/5609)) ([702473a](https://github.com/factory-callum/mocha/commit/702473a54d9348948a63b4600171afa6956ccb0b))
* **deps:** remove 'wide-align' ([#4754](https://github.com/factory-callum/mocha/issues/4754)) ([a87461c](https://github.com/factory-callum/mocha/commit/a87461caf23999a8b0a64b5f46486b53900a8461))
* **deps:** update 'glob' to v8 ([#4970](https://github.com/factory-callum/mocha/issues/4970)) ([d722d00](https://github.com/factory-callum/mocha/commit/d722d0038602eeb6968616b49ec79288100fdc72))
* **deps:** update dependency @rollup/plugin-alias to v6 ([#5718](https://github.com/factory-callum/mocha/issues/5718)) ([267d751](https://github.com/factory-callum/mocha/commit/267d751dd05270de4e18e0348584fbb12d90ce04))
* **deps:** update dependency @rollup/plugin-commonjs to v29 ([#5719](https://github.com/factory-callum/mocha/issues/5719)) ([9ed4ee5](https://github.com/factory-callum/mocha/commit/9ed4ee55d975281ea54f237d23666d7b0307a596))
* **deps:** update dependency astro to v5.17.1 ([#5703](https://github.com/factory-callum/mocha/issues/5703)) ([ec3d1fa](https://github.com/factory-callum/mocha/commit/ec3d1fa02e285a4430942942c11c376e63d395ca))
* **deps:** update dependency chai to v4.5.0 ([#5705](https://github.com/factory-callum/mocha/issues/5705)) ([870f9f8](https://github.com/factory-callum/mocha/commit/870f9f8df7d1f9cace40bfc29a9b5b79a26ccb4e))
* **deps:** update dependency chai to v6 ([#5720](https://github.com/factory-callum/mocha/issues/5720)) ([2e07be1](https://github.com/factory-callum/mocha/commit/2e07be139e3ab89c0c882e51ed948d032af4edc5))
* **deps:** update dependency cross-env to v10 ([#5721](https://github.com/factory-callum/mocha/issues/5721)) ([20b7476](https://github.com/factory-callum/mocha/commit/20b7476904592b356a48c3f89817e930c78f15cb))
* **deps:** update dependency installed-check to v10 ([#5738](https://github.com/factory-callum/mocha/issues/5738)) ([5905ed9](https://github.com/factory-callum/mocha/commit/5905ed9c2c411dfa0e7189ce0d446b2e213422e3))
* **deps:** update dependency knip to v5.83.1 ([#5708](https://github.com/factory-callum/mocha/issues/5708)) ([d833413](https://github.com/factory-callum/mocha/commit/d833413622807c91cc2dea243c2be3518e2fe10b))
* **deps:** update dependency npm-run-all2 to v8 ([#5727](https://github.com/factory-callum/mocha/issues/5727)) ([e38e0ec](https://github.com/factory-callum/mocha/commit/e38e0ec3dd91be11b2b999959e6245ec721168e3))
* **deps:** update dependency prettier to v3.8.1 ([#5709](https://github.com/factory-callum/mocha/issues/5709)) ([2f98cfd](https://github.com/factory-callum/mocha/commit/2f98cfd1e3e9fce8a3c1a645f99a6b4b3b69ea6c))
* **deps:** update dependency rimraf to v6 ([#5728](https://github.com/factory-callum/mocha/issues/5728)) ([ba124e9](https://github.com/factory-callum/mocha/commit/ba124e9161e5efd052df77dda50925c5666ccd6d))
* **deps:** update dependency rollup to v4.57.1 ([#5710](https://github.com/factory-callum/mocha/issues/5710)) ([178749d](https://github.com/factory-callum/mocha/commit/178749da1bee978b5ef109a253337ae88206365c))
* **deps:** update dependency unexpected-map to v3 ([#5736](https://github.com/factory-callum/mocha/issues/5736)) ([c1f3379](https://github.com/factory-callum/mocha/commit/c1f33798ab925c76c5f9a69dcb8c1ce71da2fbc9))
* **deps:** update dependency unist-util-visit to v5.1.0 ([#5711](https://github.com/factory-callum/mocha/issues/5711)) ([7ede894](https://github.com/factory-callum/mocha/commit/7ede8943ff8f7925b51d4e4a226ee76b0a77619d))
* **deps:** update dependency webdriverio to v9 ([#5739](https://github.com/factory-callum/mocha/issues/5739)) ([ff334df](https://github.com/factory-callum/mocha/commit/ff334df744c93f27c7cce08ced320833ee69cb2f))
* **deps:** update dependency webpack-cli to v6 ([#5741](https://github.com/factory-callum/mocha/issues/5741)) ([95c9d75](https://github.com/factory-callum/mocha/commit/95c9d75120078e4c1fbb87d23f4fd7ec1f8a5405))
* **deps:** update dependency workerpool to v9.3.4 ([#5715](https://github.com/factory-callum/mocha/issues/5715)) ([c030a3b](https://github.com/factory-callum/mocha/commit/c030a3bd4774db679ac8dc7d56e705975f1a1b6e))
* **deps:** update eslint monorepo to v10 (major) ([#5742](https://github.com/factory-callum/mocha/issues/5742)) ([fe9dc01](https://github.com/factory-callum/mocha/commit/fe9dc01850f1c191e758fd60a71d1db8b13cc968))
* **deps:** update joelwmale/webhook-action digest to 6cebc9d ([#5702](https://github.com/factory-callum/mocha/issues/5702)) ([e61c8d5](https://github.com/factory-callum/mocha/commit/e61c8d5ff69a91f039fd42bed7d7f4988740d0ca))
* **deps:** update remark ([#5745](https://github.com/factory-callum/mocha/issues/5745)) ([37a25f1](https://github.com/factory-callum/mocha/commit/37a25f174e6f3f16cae34923b86ab7d2504985ce))
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/factory-callum/mocha/issues/4865)) ([3946453](https://github.com/factory-callum/mocha/commit/3946453dedc8bbc7504f162ee95cb2b14997adc8))
* **deps:** upgrade all to latest stable ([#4556](https://github.com/factory-callum/mocha/issues/4556)) ([1a05ad7](https://github.com/factory-callum/mocha/commit/1a05ad706399f3932fbbad3ff0180456c867fb87))
* **devDeps:** remove 'cross-spawn' ([#4779](https://github.com/factory-callum/mocha/issues/4779)) ([3b4cc05](https://github.com/factory-callum/mocha/commit/3b4cc05f3fa0502d5d714a8f62ac8785267aa695))
* **devDeps:** remove unused depedencies ([#4949](https://github.com/factory-callum/mocha/issues/4949)) ([fc4ac58](https://github.com/factory-callum/mocha/commit/fc4ac58f1fda1a178b26189398b65f66f6561716))
* **devDeps:** update 'eslint' and its plugins ([#4737](https://github.com/factory-callum/mocha/issues/4737)) ([4860738](https://github.com/factory-callum/mocha/commit/4860738af9de9493fade35aea3df65dc7461e100))
* **devDeps:** update 'ESLint' to v8 ([#4926](https://github.com/factory-callum/mocha/issues/4926)) ([51d4746](https://github.com/factory-callum/mocha/commit/51d4746cf6ccefdcfcbc841c92f70efaa338e34f))
* **devDeps:** update 'prettier' ([#4776](https://github.com/factory-callum/mocha/issues/4776)) ([ac43029](https://github.com/factory-callum/mocha/commit/ac43029d6a86150a48ccd59e50e89ca10c72a9c0))
* **devDeps:** upgrade '@11ty/eleventy' to v1.0.0 ([#4844](https://github.com/factory-callum/mocha/issues/4844)) ([b46db73](https://github.com/factory-callum/mocha/commit/b46db73fa0e58c92bde925eaa4054210b771b5a9))
* **devDeps:** upgrade 'coffee-script' ([#4856](https://github.com/factory-callum/mocha/issues/4856)) ([ed640c4](https://github.com/factory-callum/mocha/commit/ed640c49a2984ccf04d0d1d516950996d8248288))
* drop support of 'growl' notification ([#4866](https://github.com/factory-callum/mocha/issues/4866)) ([ac81cc5](https://github.com/factory-callum/mocha/commit/ac81cc53788e11f1dad5dae9c300b16049ed934f))
* drop support of IE11 ([#4848](https://github.com/factory-callum/mocha/issues/4848)) ([70fe3ad](https://github.com/factory-callum/mocha/commit/70fe3adbbbda045c3cf6cc218dfa8dcfc7ab8ca1))
* drop support of Node v12 ([#4845](https://github.com/factory-callum/mocha/issues/4845)) ([d7f6ea5](https://github.com/factory-callum/mocha/commit/d7f6ea5f5d8406204053618c708634dbf5aa9670))
* enabled eslint-plugin-n ([#5280](https://github.com/factory-callum/mocha/issues/5280)) ([945d6e3](https://github.com/factory-callum/mocha/commit/945d6e3bf5a9de19c3aa26fbdac966a721006b58))
* enabled ESLint's no-unused-vars ([#5399](https://github.com/factory-callum/mocha/issues/5399)) ([d4168ae](https://github.com/factory-callum/mocha/commit/d4168aef4c21f8fd119385da1cf1794a1ec5c2e1))
* **esm:** remove code for Node v12 ([#4874](https://github.com/factory-callum/mocha/issues/4874)) ([f6695f0](https://github.com/factory-callum/mocha/commit/f6695f0df57f7ba8fae58341de0abeb7bdfd0d31))
* **esm:** remove code for Node versions &lt;10 ([#4736](https://github.com/factory-callum/mocha/issues/4736)) ([97b8470](https://github.com/factory-callum/mocha/commit/97b84708afb42e552cb906a54f9f2aa2e6a98ba4))
* fix broken link in .github/CONTRIBUTING.md ([681e843](https://github.com/factory-callum/mocha/commit/681e843800051a9d3ab66c1bfb7ad71428e34315))
* fix docs builds by re-adding eleventy and ignoring gitignore again ([#5240](https://github.com/factory-callum/mocha/issues/5240)) ([881e3b0](https://github.com/factory-callum/mocha/commit/881e3b0ca2e24284aab2a04f63639a0aa9e0ad1b))
* fix failing markdown linting ([#5193](https://github.com/factory-callum/mocha/issues/5193)) ([7e7a2ec](https://github.com/factory-callum/mocha/commit/7e7a2ecb9bf8daba7e885a880bd8314b7b6fe07d))
* fix header generation and production build crashes  ([#5100](https://github.com/factory-callum/mocha/issues/5100)) ([51502ab](https://github.com/factory-callum/mocha/commit/51502abdd8bfa44114756203e0c5c528ed4a7d8f))
* fix link in pull request template ([#5091](https://github.com/factory-callum/mocha/issues/5091)) ([a886829](https://github.com/factory-callum/mocha/commit/a88682963619e4424c9fdcdbb46f66dc9e68876a))
* fix npm scripts on windows ([#5219](https://github.com/factory-callum/mocha/issues/5219)) ([1173da0](https://github.com/factory-callum/mocha/commit/1173da0bf614e8d2a826687802ee8cbe8671ccf1))
* fix some typos in comments ([#5135](https://github.com/factory-callum/mocha/issues/5135)) ([99601da](https://github.com/factory-callum/mocha/commit/99601da68d59572b6aa931e9416002bcb5b3e19d))
* Fix tests ([#5320](https://github.com/factory-callum/mocha/issues/5320)) ([18699a0](https://github.com/factory-callum/mocha/commit/18699a0d668ed2654dd15433f03b74348baf9559))
* fix the ci ([#5020](https://github.com/factory-callum/mocha/issues/5020)) ([f8f9fd5](https://github.com/factory-callum/mocha/commit/f8f9fd57740f964df6ee31fd6514a179fce453e4))
* fix timeout issue with some XUnit tests ([53cc467](https://github.com/factory-callum/mocha/commit/53cc46755571ed53e32254fb7d896f599a1a7d1f))
* **gha:** update 'stale.yml' ([#4718](https://github.com/factory-callum/mocha/issues/4718)) [ci skip] ([9f82ccb](https://github.com/factory-callum/mocha/commit/9f82ccbd1efa35b8007fcefaa56f563f5145ae42))
* have `Tests` workflow ignore more relevant paths ([#5762](https://github.com/factory-callum/mocha/issues/5762)) ([8e2cebe](https://github.com/factory-callum/mocha/commit/8e2cebe14505ce62b0597c854bec217c60c00020))
* inline nyan reporter's write function ([#5056](https://github.com/factory-callum/mocha/issues/5056)) ([1ebff45](https://github.com/factory-callum/mocha/commit/1ebff45397853e83fb4909c1b0136957d4487528))
* **main:** release 10.7.1 ([#5189](https://github.com/factory-callum/mocha/issues/5189)) ([1528c42](https://github.com/factory-callum/mocha/commit/1528c4257a204533d1ed3c34c049a76a8c29f659))
* **main:** release 10.7.2 ([#5192](https://github.com/factory-callum/mocha/issues/5192)) ([9e0a4bd](https://github.com/factory-callum/mocha/commit/9e0a4bdc3ca7dbc7f7f9776f76efff6fdc3fb0cf))
* **main:** release 10.7.3 ([#5195](https://github.com/factory-callum/mocha/issues/5195)) ([d5766c8](https://github.com/factory-callum/mocha/commit/d5766c887e72b1bb55d5efeac33b1cadd0544b84))
* **main:** release 10.8.0 ([#5200](https://github.com/factory-callum/mocha/issues/5200)) ([6062f92](https://github.com/factory-callum/mocha/commit/6062f9252f095ab5a2659002f6637fe710e815fe))
* **main:** release 10.8.1 ([#5238](https://github.com/factory-callum/mocha/issues/5238)) ([f44f71b](https://github.com/factory-callum/mocha/commit/f44f71bd2897c4f5dcd688d838fec33fdb5818a9))
* **main:** release 10.8.2 ([#5239](https://github.com/factory-callum/mocha/issues/5239)) ([05097db](https://github.com/factory-callum/mocha/commit/05097db4f2e0118f033978b8503aec36b1867c55))
* **main:** release 11.0.0 prerelease ([#5241](https://github.com/factory-callum/mocha/issues/5241)) ([d3b2c38](https://github.com/factory-callum/mocha/commit/d3b2c386db74f0d448c7381097381dedb1c996f2))
* **main:** release 11.0.1 ([#5257](https://github.com/factory-callum/mocha/issues/5257)) ([4c558fb](https://github.com/factory-callum/mocha/commit/4c558fb83ca5d7e260961b1ebfddcd377017a608))
* **main:** release 11.0.2 ([#5269](https://github.com/factory-callum/mocha/issues/5269)) ([6caa902](https://github.com/factory-callum/mocha/commit/6caa9026eb120b136dc8210614b31310f8bff83b))
* **main:** release 11.1.0 ([#5277](https://github.com/factory-callum/mocha/issues/5277)) ([a87fb11](https://github.com/factory-callum/mocha/commit/a87fb1130a877649e564e144a73b1716b6296cbd))
* **main:** release 11.2.0 ([#5283](https://github.com/factory-callum/mocha/issues/5283)) ([b0c2696](https://github.com/factory-callum/mocha/commit/b0c269616e775689f4f28eedc0a9c5e99048139b))
* **main:** release 11.2.1 ([#5316](https://github.com/factory-callum/mocha/issues/5316)) ([0d09939](https://github.com/factory-callum/mocha/commit/0d09939fa9b710398a14e936dd02d3b5a7a478c2))
* **main:** release 11.2.2 ([#5327](https://github.com/factory-callum/mocha/issues/5327)) ([5cf2b09](https://github.com/factory-callum/mocha/commit/5cf2b09964fcfcee55eb1ecd2d9a0c56ad7bf526))
* **main:** release 11.3.0 ([#5338](https://github.com/factory-callum/mocha/issues/5338)) ([fffe569](https://github.com/factory-callum/mocha/commit/fffe5696a6759f99ee305e3ccfe3feb2c96c5acc))
* **main:** release 11.4.0 ([#5368](https://github.com/factory-callum/mocha/issues/5368)) ([5730dfc](https://github.com/factory-callum/mocha/commit/5730dfcf11e4cd48ba2b24601eaadf34a5c9b1a9))
* **main:** release 11.5.0 ([#5370](https://github.com/factory-callum/mocha/issues/5370)) ([a7ed005](https://github.com/factory-callum/mocha/commit/a7ed005bf79656c28c6b6e65a197098cdd65d7f4))
* **main:** release 11.6.0 ([#5373](https://github.com/factory-callum/mocha/issues/5373)) ([e68b9a6](https://github.com/factory-callum/mocha/commit/e68b9a64b3e36c464d0ec565c28e2ffc5b579dd3))
* **main:** release 11.7.0 ([#5378](https://github.com/factory-callum/mocha/issues/5378)) ([5d617f3](https://github.com/factory-callum/mocha/commit/5d617f3591979dfac68d8a76dfec4b33e9ea78f0))
* **main:** release 11.7.1 ([#5390](https://github.com/factory-callum/mocha/issues/5390)) ([c12d85d](https://github.com/factory-callum/mocha/commit/c12d85d4ccaae8b2a5a8c0a9de1eaf165657a291))
* **main:** release 11.7.2 ([#5398](https://github.com/factory-callum/mocha/issues/5398)) ([5f8e8a8](https://github.com/factory-callum/mocha/commit/5f8e8a89fb4cc833290549dcb1974be06514746b))
* **main:** release 11.7.3 ([#5455](https://github.com/factory-callum/mocha/issues/5455)) ([c805327](https://github.com/factory-callum/mocha/commit/c8053277699b35854eb926ffa7b3b5bebcfbdd44))
* **main:** release 11.7.4 ([#5473](https://github.com/factory-callum/mocha/issues/5473)) ([8649f39](https://github.com/factory-callum/mocha/commit/8649f394e469b0ec8612837b84707ac42ad2af62))
* **main:** release 12.0.0-beta-1 ([#5549](https://github.com/factory-callum/mocha/issues/5549)) ([e648324](https://github.com/factory-callum/mocha/commit/e6483245884847ae2e3e468956451ecb9dc31e12))
* **main:** release 12.0.0-beta-10 ([#5701](https://github.com/factory-callum/mocha/issues/5701)) ([6cb2710](https://github.com/factory-callum/mocha/commit/6cb27100c9a50c17a205803d343a2c369656f0ee))
* **main:** release 12.0.0-beta-2 ([#5552](https://github.com/factory-callum/mocha/issues/5552)) ([a7c7eb2](https://github.com/factory-callum/mocha/commit/a7c7eb2e2a21ed07a7d4f2ac04dca217eb1d27d3))
* **main:** release 12.0.0-beta-3 ([#5561](https://github.com/factory-callum/mocha/issues/5561)) ([8e595c8](https://github.com/factory-callum/mocha/commit/8e595c8aefe19e0b87b0ea929eda2a19fe050260))
* **main:** release 12.0.0-beta-4 ([#5598](https://github.com/factory-callum/mocha/issues/5598)) ([424516e](https://github.com/factory-callum/mocha/commit/424516ed3c34c6716afbf554425cf5df439cd86c))
* **main:** release 12.0.0-beta-4 ([#5620](https://github.com/factory-callum/mocha/issues/5620)) ([2fa505c](https://github.com/factory-callum/mocha/commit/2fa505ca70293fecaf5b4d8a2d79e108ebb7edfe))
* **main:** release 12.0.0-beta-5 ([#5626](https://github.com/factory-callum/mocha/issues/5626)) ([d220832](https://github.com/factory-callum/mocha/commit/d220832b8d1360d835d06cb48fd90be4a27d9a0d))
* **main:** release 12.0.0-beta-6 ([#5654](https://github.com/factory-callum/mocha/issues/5654)) ([047227f](https://github.com/factory-callum/mocha/commit/047227f7eb633c906e287d66b24f0486fe47519c))
* **main:** release 12.0.0-beta-7 ([#5660](https://github.com/factory-callum/mocha/issues/5660)) ([611b89d](https://github.com/factory-callum/mocha/commit/611b89d5f375748d181ea2a3e912214c6b4f26b1))
* **main:** release 12.0.0-beta-8 ([#5684](https://github.com/factory-callum/mocha/issues/5684)) ([bbd0ace](https://github.com/factory-callum/mocha/commit/bbd0ace3a489fd562e9881c50532d6e18db7eadc))
* **main:** release 12.0.0-beta-9 ([#5698](https://github.com/factory-callum/mocha/issues/5698)) ([430960c](https://github.com/factory-callum/mocha/commit/430960c32f239ce830c7cef87a636accfae33150))
* migrate ESLint config to flat config ([#5060](https://github.com/factory-callum/mocha/issues/5060)) ([8317f90](https://github.com/factory-callum/mocha/commit/8317f902a11a5837d00581e7926b145d20f59b61))
* more fully remove assetgraph-builder and canvas ([#5175](https://github.com/factory-callum/mocha/issues/5175)) ([1883c41](https://github.com/factory-callum/mocha/commit/1883c41a49fad009bd407efc1bece3a5c75fd10a))
* move callback and object typedefs to a new types.d.ts ([#5351](https://github.com/factory-callum/mocha/issues/5351)) ([3300d21](https://github.com/factory-callum/mocha/commit/3300d2155a1b06059fbe89c98a1d8bf979539019))
* move nyc config changes from package.json into .nycrc ([#5668](https://github.com/factory-callum/mocha/issues/5668)) ([e923e40](https://github.com/factory-callum/mocha/commit/e923e4063f6a24dcaf7c6d7c7a3c8be998cb7980))
* normalized ESLint config to v9's recommended structure ([#5575](https://github.com/factory-callum/mocha/issues/5575)) ([7f9ed1f](https://github.com/factory-callum/mocha/commit/7f9ed1fb3480e0658c2c7d84c60a1b505c941ce5))
* pin node-lts tests to 22.11.0 ([#5279](https://github.com/factory-callum/mocha/issues/5279)) ([664e1f4](https://github.com/factory-callum/mocha/commit/664e1f49f7ae214a9666c90f388407e9fa100309))
* prevent unwanted Prettier rewrites ([#5591](https://github.com/factory-callum/mocha/issues/5591)) ([3ea1578](https://github.com/factory-callum/mocha/commit/3ea15789ddb4b77c591d9da36d2476ac359de00d))
* remove `husky` for now ([#5127](https://github.com/factory-callum/mocha/issues/5127)) ([6dda9a4](https://github.com/factory-callum/mocha/commit/6dda9a476b54a9c00bacdb45aac74586ebeb42c2)), closes [#5124](https://github.com/factory-callum/mocha/issues/5124)
* remove broken browser-test.yml ([#5615](https://github.com/factory-callum/mocha/issues/5615)) ([33ce345](https://github.com/factory-callum/mocha/commit/33ce345f9ab4f47573a4994c5c01de6eda2af45d))
* remove deprecated Runner signature ([#4861](https://github.com/factory-callum/mocha/issues/4861)) ([b7b849b](https://github.com/factory-callum/mocha/commit/b7b849b76b19949303a2e105eea8ce4f9df49e02))
* remove extra newline ([bbe2bdb](https://github.com/factory-callum/mocha/commit/bbe2bdbb69f7aa560645a5ab2cbd596dd0b43448))
* remove failing hyperlink linkcheck task ([#5176](https://github.com/factory-callum/mocha/issues/5176)) ([24560c1](https://github.com/factory-callum/mocha/commit/24560c1532b8e67d1254b489fcc6f84c4033c0e1))
* remove legacy `docs/` ([#5583](https://github.com/factory-callum/mocha/issues/5583)) ([d8c310e](https://github.com/factory-callum/mocha/commit/d8c310e3eddd235be55ad1891cde84c3be6f56f3))
* remove nanoid as dependency ([#5024](https://github.com/factory-callum/mocha/issues/5024)) ([45e97af](https://github.com/factory-callum/mocha/commit/45e97af81f87c7ac71433b4558e58ad474ffeba8))
* remove Node.js 18 from test-smoke in CI too ([d643105](https://github.com/factory-callum/mocha/commit/d643105aa6f3fbac9d13e8a44f4c4c7302512193))
* remove now-unused `utils.inherits` ([#5766](https://github.com/factory-callum/mocha/issues/5766)) ([d0a636b](https://github.com/factory-callum/mocha/commit/d0a636b5e9bd5a4b1c8864b91aec94f12f16490f))
* remove prerelease setting in release-please config ([#5363](https://github.com/factory-callum/mocha/issues/5363)) ([8878f22](https://github.com/factory-callum/mocha/commit/8878f222c418a0bf4fe170c17573c30b5ea2d567))
* remove stale workflow ([#5029](https://github.com/factory-callum/mocha/issues/5029)) ([b41e985](https://github.com/factory-callum/mocha/commit/b41e98533aa0fb87d7ba61163254881607a8a8c5))
* remove touch as dev dependency ([#5023](https://github.com/factory-callum/mocha/issues/5023)) ([48002bc](https://github.com/factory-callum/mocha/commit/48002bc60144c25060bf91359620c4a0284e8284))
* remove trailing spaces ([#5475](https://github.com/factory-callum/mocha/issues/5475)) ([7f68e5c](https://github.com/factory-callum/mocha/commit/7f68e5c1565606bcebeb715b8591c52973d00dff))
* remove trailing whitespace in SECURITY.md ([7563e59](https://github.com/factory-callum/mocha/commit/7563e59ae3c78ada305d26eadb86998ab54342da))
* remove unnecessary canvas dependency ([#5069](https://github.com/factory-callum/mocha/issues/5069)) ([53a4baf](https://github.com/factory-callum/mocha/commit/53a4bafbdeb32576440b0a21787f2525585411c0))
* remove unused assets folder ([#5638](https://github.com/factory-callum/mocha/issues/5638)) ([ddf8644](https://github.com/factory-callum/mocha/commit/ddf864482ff66b1ca46ef7f08e63ca923222e717))
* remove unused fossaignore ([#5769](https://github.com/factory-callum/mocha/issues/5769)) ([8a0eaf7](https://github.com/factory-callum/mocha/commit/8a0eaf7997ca8f97676412e0e89c1a7df9c0b5c3))
* remove uuid dev dependency ([#5022](https://github.com/factory-callum/mocha/issues/5022)) ([ee2b70e](https://github.com/factory-callum/mocha/commit/ee2b70e8e82b0b67347d41028fa45521d43633d9))
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/factory-callum/mocha/issues/4863)) ([592905b](https://github.com/factory-callum/mocha/commit/592905b204fb3b6ef366f839994595e236a27e06))
* rename 'master' to 'main' in docs and tooling ([#5130](https://github.com/factory-callum/mocha/issues/5130)) ([b6aa7e8](https://github.com/factory-callum/mocha/commit/b6aa7e85b821a7859bb6e372d8c3efe67936d7c3))
* replace `fs-extra` with newer `fs` built-ins ([#5284](https://github.com/factory-callum/mocha/issues/5284)) ([75dcf8c](https://github.com/factory-callum/mocha/commit/75dcf8c6c40ed1ce134ae5e174b6f4c4ca4d8c42))
* replace `nps` with npm scripts ([#5128](https://github.com/factory-callum/mocha/issues/5128)) ([c44653a](https://github.com/factory-callum/mocha/commit/c44653a3a04b8418ec24a942fa7513a4673f3667)), closes [#5126](https://github.com/factory-callum/mocha/issues/5126)
* replace deprecated 'String.prototype.substr()' ([#4852](https://github.com/factory-callum/mocha/issues/4852)) ([a816130](https://github.com/factory-callum/mocha/commit/a81613070cebd545043cdeab97e9000ecaaae1a7))
* revert "chore(main): release 12.0.0-beta-4 ([#5598](https://github.com/factory-callum/mocha/issues/5598))" ([#5619](https://github.com/factory-callum/mocha/issues/5619)) ([dba8091](https://github.com/factory-callum/mocha/commit/dba809196541df415fac2681822f5cd35cf20442))
* revert [#5069](https://github.com/factory-callum/mocha/issues/5069) to restore Netlify builds ([#5095](https://github.com/factory-callum/mocha/issues/5095)) ([3345eff](https://github.com/factory-callum/mocha/commit/3345eff154d40802ba4470b73fd0040c15f6c4f9))
* rewrite base path instead of copy-pasting ([#5431](https://github.com/factory-callum/mocha/issues/5431)) ([c6c6740](https://github.com/factory-callum/mocha/commit/c6c6740fb45da43510f86c1d22ea46ce9ee6a7ae))
* run Netlify deploy on Node v16 ([#4778](https://github.com/factory-callum/mocha/issues/4778)) [ci skip] ([9fbf3ae](https://github.com/factory-callum/mocha/commit/9fbf3aeb2e6c8c07ced79122f79a1ce73191d0f4))
* run tests when PR is retargeted ([#5761](https://github.com/factory-callum/mocha/issues/5761)) ([3481b1e](https://github.com/factory-callum/mocha/commit/3481b1e32c3ad85e38af9639fc39b53685dd1922))
* **site:** fix supporters' download ([#4859](https://github.com/factory-callum/mocha/issues/4859)) ([0608fa3](https://github.com/factory-callum/mocha/commit/0608fa3cab27d8ceaf18976d6fb128b9550fb989))
* switch 'linkify-changelog.js' to ESM ([#4812](https://github.com/factory-callum/mocha/issues/4812)) [ci skip] ([f297790](https://github.com/factory-callum/mocha/commit/f297790fb7d9035c001e5aca82b8487924354cdf))
* switch from Coveralls to Codecov ([#5447](https://github.com/factory-callum/mocha/issues/5447)) ([f4e7e54](https://github.com/factory-callum/mocha/commit/f4e7e54eb285765d7c50bce9c501db2e1b1e22be))
* switch reporters from util.inherits to ES2015 classes ([#5180](https://github.com/factory-callum/mocha/issues/5180)) ([c3f32ce](https://github.com/factory-callum/mocha/commit/c3f32ce7e2f39d14beb325892953d3fb1c4922e6))
* switch Runnable, Hook, and Test from util.inherits to ES2015 classes ([#5178](https://github.com/factory-callum/mocha/issues/5178)) ([1378fd8](https://github.com/factory-callum/mocha/commit/1378fd86071a0c59c0a991569441fe398d0911d8))
* switch Suite from util.inherits to ES2015 classes ([#5179](https://github.com/factory-callum/mocha/issues/5179)) ([1ce690e](https://github.com/factory-callum/mocha/commit/1ce690e590ca7bff7f47b108d3a5cc61dde6aa1b))
* switch two-column list styles to be opt-in ([#5110](https://github.com/factory-callum/mocha/issues/5110)) ([e030115](https://github.com/factory-callum/mocha/commit/e0301154101989a26877fbb8a1e9c869c9f3e4a6))
* **test:** drop AMD/'requirejs' ([#4857](https://github.com/factory-callum/mocha/issues/4857)) ([785aeb1](https://github.com/factory-callum/mocha/commit/785aeb1ff22793086543c559f93e5b482621e820))
* unify caught errors as err ([#5439](https://github.com/factory-callum/mocha/issues/5439)) ([d4912e7](https://github.com/factory-callum/mocha/commit/d4912e705cf9ae1c3aa274b6449a6a0ff6d408c5))
* unpin node-version in release-please ([#5550](https://github.com/factory-callum/mocha/issues/5550)) ([62c90cd](https://github.com/factory-callum/mocha/commit/62c90cd2aea4c719d2014e7134b2a1d7c189fd7a))
* update dependencies ([#4818](https://github.com/factory-callum/mocha/issues/4818)) ([1825645](https://github.com/factory-callum/mocha/commit/18256456822e46fa6d9952a15f264833371874ca))
* update dependencies ([#4843](https://github.com/factory-callum/mocha/issues/4843)) ([632e602](https://github.com/factory-callum/mocha/commit/632e6023584bcc877685de4fb5c5128e370b2b6a))
* update dependencies ([#4878](https://github.com/factory-callum/mocha/issues/4878)) ([fbe7a24](https://github.com/factory-callum/mocha/commit/fbe7a24269631b6f7c5d259cc8ce26b83b2e60dc))
* Update experimental module detection test and pin exact Node versions ([#5417](https://github.com/factory-callum/mocha/issues/5417)) ([2489090](https://github.com/factory-callum/mocha/commit/2489090223f2629e4a380abe4cc6d46858ada922))
* update Rollup to v4 ([#5510](https://github.com/factory-callum/mocha/issues/5510)) ([cafa782](https://github.com/factory-callum/mocha/commit/cafa782f010021e7055f8482ede2c02c6503f0a0))
* update some devDependencies ([#4733](https://github.com/factory-callum/mocha/issues/4733)) ([e975675](https://github.com/factory-callum/mocha/commit/e97567585726ca407be50baa5551ad8c5df07749))
* update some devDependencies ([#4775](https://github.com/factory-callum/mocha/issues/4775)) ([9c9fcb5](https://github.com/factory-callum/mocha/commit/9c9fcb5fd769ea5bf8ec6bc513478fa777055d5a))
* update some devDependencies ([#4816](https://github.com/factory-callum/mocha/issues/4816)) ([bc0fda2](https://github.com/factory-callum/mocha/commit/bc0fda2845f650ef1926a3be6fccefd72c2c8c88))
* update spam filter ([#5645](https://github.com/factory-callum/mocha/issues/5645)) ([cf945fb](https://github.com/factory-callum/mocha/commit/cf945fb73b7c5a74f0856cabca5b5b1c8a6ff1c8))
* update tagline ([#5635](https://github.com/factory-callum/mocha/issues/5635)) ([8ff0209](https://github.com/factory-callum/mocha/commit/8ff0209db575c8231eea77e6ab23e6fe95620c92))
* use `ps-list` instead of `pidtree` to remove wmic ([#5479](https://github.com/factory-callum/mocha/issues/5479)) ([b2985b3](https://github.com/factory-callum/mocha/commit/b2985b3428b4b88ca220a14a26e9eb7139e8d445))
* use OIDC to publish to npm ([#5681](https://github.com/factory-callum/mocha/issues/5681)) ([5567aed](https://github.com/factory-callum/mocha/commit/5567aed50a00b63074d5c7703c6d8196dee92088))
* use standard 'Promise.allSettled' instead of polyfill ([#4905](https://github.com/factory-callum/mocha/issues/4905)) ([77c18d2](https://github.com/factory-callum/mocha/commit/77c18d29c565e68a0d487e357765acb5ec776cc6))


### 🤖 Automation

* **deps:** bump actions/checkout in the github-actions group ([#5419](https://github.com/factory-callum/mocha/issues/5419)) ([03ac2d0](https://github.com/factory-callum/mocha/commit/03ac2d0e6e75e95b3dc7fb08f2e1a1117d9718ca))
* **deps:** bump actions/checkout in the github-actions group ([#5547](https://github.com/factory-callum/mocha/issues/5547)) ([561eb03](https://github.com/factory-callum/mocha/commit/561eb039f7cfc36563a9583b17c7d4cb7ec30652))
* **deps:** bump actions/setup-node in the github-actions group ([#5459](https://github.com/factory-callum/mocha/issues/5459)) ([48c6f40](https://github.com/factory-callum/mocha/commit/48c6f4068b5d22ebc49220900f0b53f8ecdc2b74))
* **deps:** bump actions/setup-node in the github-actions group ([#5503](https://github.com/factory-callum/mocha/issues/5503)) ([9a70533](https://github.com/factory-callum/mocha/commit/9a7053349589344236b20301de965030eaabfea9))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5648](https://github.com/factory-callum/mocha/issues/5648)) ([fed6bbd](https://github.com/factory-callum/mocha/commit/fed6bbdb891c518e61e8ef4bbf07ed46b469f860))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5653](https://github.com/factory-callum/mocha/issues/5653)) ([e06cce7](https://github.com/factory-callum/mocha/commit/e06cce7a49b79a163e33db166e9b078b0d7b4001))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5724](https://github.com/factory-callum/mocha/issues/5724)) ([87224d8](https://github.com/factory-callum/mocha/commit/87224d8400fa3b074f77a8ba1baadf7e0b99d864))
* **deps:** bump OctoGuide/bot in the github-actions group ([#5791](https://github.com/factory-callum/mocha/issues/5791)) ([fb6bfd6](https://github.com/factory-callum/mocha/commit/fb6bfd6425729a3516c60933298988a5711a6edc))
* **deps:** bump the github-actions group with 1 update ([#5132](https://github.com/factory-callum/mocha/issues/5132)) ([e536ab2](https://github.com/factory-callum/mocha/commit/e536ab25b308774e3103006c044cb996a2e17c87))
* **deps:** bump the github-actions group with 2 updates ([#5125](https://github.com/factory-callum/mocha/issues/5125)) ([7ac67f3](https://github.com/factory-callum/mocha/commit/7ac67f3735b1ba6b1e1565ab9136d83c50f58abf))
* **dep:** update `diff` from v7 to v8 ([#5605](https://github.com/factory-callum/mocha/issues/5605)) ([8ca311c](https://github.com/factory-callum/mocha/commit/8ca311c6c9b0d353b1c9d65b5751296d9baddd83))
* **dev-deps:** upgrade `eslint` from v8 to v9 ([#5559](https://github.com/factory-callum/mocha/issues/5559)) ([bb24ca8](https://github.com/factory-callum/mocha/commit/bb24ca8fde15471ff68d5b01b74c2d7e6047d966))
* **dev-deps:** upgrade `markdownlint-cli` to latest v0.46.0  ([#5560](https://github.com/factory-callum/mocha/issues/5560)) ([a124f1d](https://github.com/factory-callum/mocha/commit/a124f1d3b7d0f8277962cae295cd43878294e183))
* **dev-deps:** upgrade `nyc` from 15 to 17 ([#5556](https://github.com/factory-callum/mocha/issues/5556)) ([599ab01](https://github.com/factory-callum/mocha/commit/599ab013f526e78b3888a092a928ea4bc67138c0))
* **docs/dev-deps:** use JS-native `fetch` to get supporters data instead of external `needle` ([#5643](https://github.com/factory-callum/mocha/issues/5643)) ([e37e56f](https://github.com/factory-callum/mocha/commit/e37e56fbe6a1072f1784ef87278d46f7ac48cdb8))
* initial file implementation for ocotoguide ([#5608](https://github.com/factory-callum/mocha/issues/5608)) ([a5f5c64](https://github.com/factory-callum/mocha/commit/a5f5c6442505069573a17798a515f267c24a38f3))
* run `npm audit fix` ([#5695](https://github.com/factory-callum/mocha/issues/5695)) ([c7b00b0](https://github.com/factory-callum/mocha/commit/c7b00b0e4f03583c4dcc407f28a5453df436f32b))
* update npm command for format ([#5603](https://github.com/factory-callum/mocha/issues/5603)) ([c6a29cc](https://github.com/factory-callum/mocha/commit/c6a29ccb38f81d65100cb2a0e6d73ad4303f58fb))
* **v10.0.0:** release ([023f548](https://github.com/factory-callum/mocha/commit/023f548213e571031b41cabbcb8bb20e458b2725))
* **v10.0.0:** update CHANGELOG ([62b1566](https://github.com/factory-callum/mocha/commit/62b1566211a631b22f4bd7d888cd2c046efdd9e4))
* **v10.1.0:** release ([5f96d51](https://github.com/factory-callum/mocha/commit/5f96d511dbf913f135b92198aab721a27f6b44fe))
* **v10.1.0:** update CHANGELOG ([ed74f16](https://github.com/factory-callum/mocha/commit/ed74f16878f6520411d9a391c5f184056be6da30))
* **v10.2.0:** release ([202e9b8](https://github.com/factory-callum/mocha/commit/202e9b8b4d1b6611c96d95d631c49d631d88c827))
* **v10.2.0:** update CHANGELOG ([6782d6d](https://github.com/factory-callum/mocha/commit/6782d6d0757a5e7b49b291bcae173316ec00c513))
* **v9.1.0:** release ([014e47a](https://github.com/factory-callum/mocha/commit/014e47a8b07809e73b1598c7abeafe7a3b57a8f7))
* **v9.1.0:** update CHANGELOG [ci skip] ([3a14b28](https://github.com/factory-callum/mocha/commit/3a14b28bdfd785828ec862fe9fa8d19a651fd63c))
* **v9.1.1:** release ([654b5df](https://github.com/factory-callum/mocha/commit/654b5df4391172e69fe226dc36ebd1c89b20be53))
* **v9.1.1:** update CHANGELOG [ci skip] ([a26cca9](https://github.com/factory-callum/mocha/commit/a26cca9254f41ed5a049990da8093a9c4151e0fd))
* **v9.1.2:** release ([18a1055](https://github.com/factory-callum/mocha/commit/18a1055396744e3284b113bb114f52298f5e35ab))
* **v9.1.2:** update CHANGELOG [ci skip] ([06f3f63](https://github.com/factory-callum/mocha/commit/06f3f636c9056e88d79c64f50d0d0c14f5d7ac6c))
* **v9.1.3:** release ([28b4824](https://github.com/factory-callum/mocha/commit/28b482472a519b7abaf30a18b8ad709707bfd5a7))
* **v9.1.3:** update CHANGELOG [ci skip] ([3dcc2d9](https://github.com/factory-callum/mocha/commit/3dcc2d9563c7a74edad2a68bcee2a3990140ac70))
* **v9.1.4:** release ([0a1b7f8](https://github.com/factory-callum/mocha/commit/0a1b7f8a1505738449e8b0275d91664b5bae3d95))
* **v9.1.4:** update CHANGELOG [ci skip] ([a04d050](https://github.com/factory-callum/mocha/commit/a04d050b42819602e5c952a31a8162470a39db35))
* **v9.2.0:** release ([cc51b8f](https://github.com/factory-callum/mocha/commit/cc51b8fb42c4919e1304724bdb1a90699d17cf85))
* **v9.2.0:** update CHANGELOG [ci skip] ([dea3115](https://github.com/factory-callum/mocha/commit/dea3115123116f5d9adcd0fe5f2ae0a86dda03a1))
* **v9.2.1:** release ([547ffd7](https://github.com/factory-callum/mocha/commit/547ffd73535088322579d3d2026432112eae3d4b))
* **v9.2.1:** update CHANGELOG [ci skip] ([ca7432a](https://github.com/factory-callum/mocha/commit/ca7432a86541d1b3f8285403d11c8aa3acad2166))
* **v9.2.2:** release ([24b5243](https://github.com/factory-callum/mocha/commit/24b5243514fee35bb78cf81d7fa541112a566a22))
* **v9.2.2:** update CHANGELOG [ci skip] ([22a1560](https://github.com/factory-callum/mocha/commit/22a156064ccfffca8595171cdf0d8401272a7912))
